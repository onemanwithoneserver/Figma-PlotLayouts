...
const VideoTourSection: React.FC = () => {
  ...
  return (
    <div className="font-outfit border border-[#C8DBCF] rounded-[2px] overflow-hidden bg-[#0B1F17] w-full relative group shadow-sm cursor-pointer">
      <img
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        ...
        >
          <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-[var(--radius-lg)] bg-white/20 backdrop-blur-md border border-white/30 flex items-center justify-center shadow-[0_4px_12px_rgba(10,26,16,0.15)] group-hover:scale-110 transition-all duration-300" style={{ background: isPlaying ? '#15653A' : undefined }}>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex items-end justify-between px-4 py-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        <div className="flex items-center gap-2">
          <div className="w-2 h-2 rounded-full bg-[#DC2626] animate-pulse shadow-[0_0_8px_rgba(214,48,49,0.8)]" />

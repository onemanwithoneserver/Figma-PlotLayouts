    ...
    <>
      <div className="fixed bottom-0 left-0 right-0 z-50 flex justify-center pointer-events-none font-inter">
        <motion.div
          ...
          className="w-full max-w-[390px] bg-[#ECECE8] shadow-[0_-5px_10px_#CBCBC7,0_-1px_2px_#FFFFFF] pointer-events-auto pb-safe"
          role="toolbar"
        >
          <div className="flex items-end justify-between px-3 py-2">
            ...
            >
              <div className={`transition-colors duration-200 ${saved ? 'text-[#2F6F4E]' : 'text-[#5C6B63]'}`}>
                {saved ? <BookmarkOutlinedIcon sx={{ fontSize: 22 }} /> : <BookmarkBorderOutlinedIcon sx={{ fontSize: 22 }} />}
              </div>
              <span className={`text-[11px] font-semibold tracking-wide transition-colors duration-200 ${saved ? 'text-[#2F6F4E]' : 'text-[#5C6B63]'}`}>
                save
              </span>
            </motion.button>
            ...
            <motion.button
              ...
              className="flex flex-col items-center gap-1 w-14 py-1 group"
            >
              <VisibilityOffOutlinedIcon sx={{ fontSize: 22 }} className="text-[#5C6B63] transition-colors" />
              <span className="text-[11px] font-semibold text-[#5C6B63] tracking-wide transition-colors">
                hide
              </span>
            </motion.button>
            ...
            <div className="flex flex-col items-center -mt-6 relative z-10">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="w-14 h-14 rounded-[8px] flex items-center justify-center shadow-[4px_4px_8px_#CBCBC7,-4px_-4px_8px_#FFFFFF] active:shadow-[inset_3px_3px_6px_rgba(0,0,0,0.15)] border-[3px] border-[#ECECE8] relative overflow-hidden group/btn"
                style={{ background: 'linear-gradient(135deg, #2F6F4E, #1E4D35)' }}
              >
                {/* Light Sweep */}
                <div className="absolute top-0 -left-[100%] w-full h-full bg-gradient-to-r from-transparent via-white/10 to-transparent skew-x-[-20deg] group-hover/btn:left-[100%] transition-all duration-700 pointer-events-none" />
                <PhoneOutlinedIcon sx={{ fontSize: 24, color: '#ffffff' }} />
              </motion.button>
              <span className="text-[11px] font-bold text-[#2F6F4E] tracking-widest mt-1.5">
                contact
              </span>
            </div>
            ...
            <motion.button
              ...
              className="flex flex-col items-center gap-1 w-14 py-1 group"
            >
              <ShareOutlinedIcon sx={{ fontSize: 22 }} className="text-[#5C6B63] transition-colors" />
              <span className="text-[11px] font-semibold text-[#5C6B63] tracking-wide transition-colors">
                share
              </span>
            </motion.button>
            ...
            <motion.button
              ...
              className="flex flex-col items-center gap-1 w-14 py-1 group"
            >
              <CloseOutlinedIcon sx={{ fontSize: 22 }} className="text-[#C65A3A] transition-colors" />
              <span className="text-[11px] font-semibold text-[#C65A3A] tracking-wide transition-colors">
                close
              </span>
            </motion.button>
      ...
      <Snackbar
        ...
        sx={{ 
          ...
          '& .MuiSnackbarContent-root': { 
            ...
            minWidth: 'auto',
            textAlign: 'center',
            boxShadow: '5px 5px 10px #CBCBC7, -5px -5px 10px #FFFFFF'
          } 
        }}
      />

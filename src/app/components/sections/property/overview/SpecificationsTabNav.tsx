  ...
  return (
    <div className="w-full relative flex items-center py-0.5">
      <button
        ...
        className={`flex-shrink-0 flex items-center justify-center h-8 rounded-[4px] text-[#666666] hover:text-[#1A1A1A] hover:bg-[#F0F0F0] transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500/50 overflow-hidden ${
          canScrollLeft ? 'w-8 mr-1 opacity-100 pointer-events-auto' : 'w-0 mr-0 opacity-0 pointer-events-none'
        }`}
      >
      ...
      <button
        ...
        className={`flex-shrink-0 flex items-center justify-center h-8 rounded-[4px] text-[#666666] hover:text-[#1A1A1A] hover:bg-[#F0F0F0] transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500/50 overflow-hidden ${
          canScrollRight ? 'w-8 ml-1 opacity-100 pointer-events-auto' : 'w-0 ml-0 opacity-0 pointer-events-none'
        }`}
      >
